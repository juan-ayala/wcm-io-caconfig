...
(function (angular, Coral) {
  ...
  propertyDropdown.$inject = ["$rootScope", "$timeout", "templateUrlList", "inputMap", "uiService"];

  function propertyDropdown($rootScope, $timeout, templateList, inputMap, uiService) {
    var directive = {
